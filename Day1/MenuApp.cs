   ...
   public class Menu
    {
        ...
        public void AcceptData()
        {
            ...
            switch (no)
            {
                case 1: Console.WriteLine("This application will allow you to create a pattern in pyramid structure.");
                    break;
                case 2: Console.WriteLine("This application will allow you to add two primary colors and displays the third color.");
                    break;
